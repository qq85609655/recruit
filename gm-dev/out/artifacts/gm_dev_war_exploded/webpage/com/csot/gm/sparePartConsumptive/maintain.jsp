    ...
    <div style="width: 700px; margin: 10px" align="center">
      ...
      <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
        ...
        <table class="form-table" border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td class="form-label" style="width: 230px;">原料号：<input id="oldNumber" name="oldNumber" class="mini-lookup"
              style="width: 168px; margin: 0 0 0 0" textField="partNo" valueField="id"
              popupWidth="auto" showPopupOnClick="true" allowInput="false" emptyText="请选择原料号"
              popup="#gridPanelPartNo" grid="#datagridPartNo" multiSelect="false" value="" text="" />
          ...
          <tr>
            <td class="form-label" style="width: 230px;">维修号：<input id="wxlh" emptyText="生成维修料号" allowInput="false" name="wxlh"
              class="mini-textbox" value="" style="width: 168px" required="" /></td>
          </tr>
        </table>
      </fieldset>
