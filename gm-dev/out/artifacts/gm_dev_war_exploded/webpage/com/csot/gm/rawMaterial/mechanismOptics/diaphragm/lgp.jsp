        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="combo1" class="mini-combobox" name="properties['materialQualityId']" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${materialQualityEnumTypeId}" 
              required="true" allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 220px;">型号：
            <input id="combo6" class="mini-combobox" name="properties['versionId']" onvalidation="onComboValidation"
              style="width: 180px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${versionEnumTypeId}" 
              required="true" allowInput="true" textField="text" pinyinField="tag"></td>
            ...
            <input id="combo3" class="mini-combobox" name="properties['thicknessId']"
              ...
              url="rawMaterial/getComboData?enumTypeId=${thicknessEnumTypeId}" required="true"
          ...
          <tr>
            ...
            <input id="combo4" class="mini-combobox" name="properties['upVersionId']"
              ...
              url="rawMaterial/getComboData?enumTypeId=${upVersionEnumTypeId}" required="true"
              allowInput="true" textField="text" pinyinField="tag"></td>
            ...
            <input id="combo5" class="mini-combobox" name="properties['modelNameId']"
              ...
              url="rawMaterial/getComboData?enumTypeId=${modelNameEnumTypeId}" required="true"
              allowInput="true" textField="text" pinyinField="tag"></td>
