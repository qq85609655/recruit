    ...
    <div style="width: 700px; margin: 10px" align="center">
      ...
      <fieldset class="fieldset" id="fd3" style="width: 650px; font-family: 微软雅黑;">
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 224px;">功率： <input id="combo11"
              class="mini-combobox" name="properties['powerId']" style="width: 180px;"
            ...
            <td class="form-label" style="width: 175px;">用途： <input id="combo12"
              class="mini-combobox" name="properties['applicationId']" style="width: 130px;"
              valueField="id" onvalidation="onComboValidation"
              url="rawMaterial/getComboData?enumTypeId=${applicationEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
