...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  ...
  <%@ include file="/webpage/com/csot/gm/rawMaterial/classAndUserInfo.jsp"%>
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 200px;">电容值：
            <input id="combo1" class="mini-combobox" name="properties['capacityValueId']" onvaluechanged="onDeptChanged('1')"
              style="width: 105px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${capacityValueEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">额定电压(V)：
            ...
            <input id="combo3" class="mini-combobox" name="properties['temperatureId']"
              style="width: 120px;" valueField="id" onvalidation="onComboValidation" onvaluechanged="onDeptChanged('3')"
              url="rawMaterial/getComboData?enumTypeId=${temperatureEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 200px;">pin间距：
            <input id="combo5" class="mini-combobox" name="properties['pinDistanceId']"
              style="width: 110px;" valueField="id" onvalidation="onComboValidation"
              url="rawMaterial/getComboData?enumTypeId=${pinDistanceEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 240px;" colspan="2">供应商料号：
            <input id="combo4" class="mini-combobox" name="properties['vendorNoId']" onvalidation="onComboValidation"
              style="width: 160px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${vendorNoEnumTypeId}" required="" allowInput="true"
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        <span>料号生成属性（料号规则-电子-适用于3409）</span>
      </legend>
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 200px;">大分类码：
            <input id="combobigClass" class="mini-combobox" name="properties['bigClassId']"
              style="width: 100px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${bigClassEnumTypeId}" required=""
            ...
            <input id="combo7" class="mini-combobox" name="properties['subClassId']"
              style="width: 115px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${subClassEnumTypeId}" required=""
              allowInput="false" textField="text" pinyinField="tag"></td>             
            <td class="form-label" style="width: 200px;">分类：
            <input id="combo8" class="mini-combobox" name="properties['classId']"
              style="width: 120px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${classEnumTypeId}" required=""
              allowInput="false" textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 200px;">输入电压种类：
            <input id="combo9" class="mini-combobox" name="properties['inputVoltageTypeId']"
              style="width: 75px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${inputVoltageTypeEnumTypeId}" required=""
              allowInput="false" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">电容值：
            <input id="combo10" class="mini-combobox" name="properties['capacityValueId']" onvaluechanged="onDeptChanged('10')"
              style="width: 115px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${capacityValueEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">额定电压(V)：
            <input id="combo11" class="mini-combobox" name="properties['ratedVoltageId']"
              style="width: 80px;" valueField="id" onvalidation="onComboValidation" onvaluechanged="onDeptChanged('11')"
              url="rawMaterial/getComboData?enumTypeId=${ratedVoltageEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            ...
            <input id="combo12" class="mini-combobox" name="properties['temperatureId']"
              style="width: 100px;" valueField="id" onvalidation="onComboValidation" onvaluechanged="onDeptChanged('12')"
              url="rawMaterial/getComboData?enumTypeId=${temperatureEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">流水号：
            <input id="flowNo" name="properties['flowNoId']" value="X" class="mini-textbox" style="width:110px" allowInput="false"/></td>
          </tr>
          </table>
    </fieldset>
