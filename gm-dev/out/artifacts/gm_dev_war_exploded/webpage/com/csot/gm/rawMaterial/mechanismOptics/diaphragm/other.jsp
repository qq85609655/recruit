    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 130px;">复合：
            <input id="combo1" class="mini-combobox" name="properties['complexId']" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${complexEnumTypeId}" 
            ...
            <input id="combo2" class="mini-combobox" name="properties['vendorId']" onvalidation="onComboValidation"
              style="width: 145px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${vendorEnumTypeId}" 
              required="" allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 120px;">型号：
            <input id="combo3" class="mini-combobox" name="properties['versionId']"
          ...
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['modelNameId']"
              ...
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 120px;">厚度(mm)
            <input id="combo6" class="mini-combobox" name="properties['thicknessId']"
