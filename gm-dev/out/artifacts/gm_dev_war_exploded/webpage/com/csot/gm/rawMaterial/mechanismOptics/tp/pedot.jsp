        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="combo1" class="mini-combobox" name="properties['vendorId']"
              style="width: 100px;" valueField="id" onvalidation="onComboValidation" onvaluechanged="onDeptChanged('1')"
              url="rawMaterial/getComboData?enumTypeId=${vendorEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">存储方式：
            <input id="combo4" class="mini-combobox" name="properties['storageModeId']" onvalidation="onComboValidation"
              style="width: 85px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${storageModeEnumTypeId}" required="" allowInput="true"
          ...
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['upVersionId']" onvalidation="onComboValidation"
              style="width: 110px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${upVersionEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
