    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          ...
          <tr>
            <td class="form-label" style="width: 160px;">Viscosity粘度：
            <input id="combo4" class="mini-combobox" name="properties['viscosityId']" onvalidation="onComboValidation"
              style="width: 60px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${viscosityEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">固化UV波段：
            <input id="combo5" class="mini-combobox" name="properties['uvWaveRangeId']"
            ...
            <input id="combo6" class="mini-combobox" name="properties['deadlineId']" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${deadlineEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 160px;">包装规格：
            <input id="combo7" class="mini-combobox" name="properties['packageId']"
