...
<div class="mini-fit">
      ...
      <table class="formTable" style="table-layout: fixed;">
        <tr>
          ...
          <td class="formContent"><input id="propertyName" class="mini-textbox" required="true"
            value="" onvalidation="ValidErrorText" /><label id="name_error" class="errorText"></label></td>
        </tr>
        <tr>
  ...
  <script>
      ...
      function onOk(e) {
        ...
        var addData = partId + "," + propertyName + "," + propertyValue;
        
        
        var messageId = mini.loading("正在更新中!");
        $.ajax({
          url : "propertyValue/addPropertyValues/" + addData,
          type : "post",
