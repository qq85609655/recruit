      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="7">
          ...
          <tr>
            ...
            <input id="sp2" name="properties['weightId']" class="mini-spinner" style="width:130px" minValue="0" maxValue="99999" format="n3" required="true"/></td>
          </tr>
          <tr>
            ...
            <input id="combo4" class="mini-combobox" name="properties['foamRateId']" onvalidation="onComboValidation"
          ...
          <tr>
            ...
            <input id="combo7" class="mini-combobox" name="properties['suppPropertyId']" value="3" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${suppPropertyEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
        </table>
    </fieldset>
    
    <%@ include file="/webpage/com/csot/gm/rawMaterial/packMaterial/cover.jsp"%>
