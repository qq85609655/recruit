      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="sp2" name="properties['outlineLengthId']" class="mini-spinner" style="width:70px" minValue="0" maxValue="99999" format="n0" required="true"/></td>
            ...
            <input id="sp2" name="properties['outlineHeightId']" class="mini-spinner" style="width:70px" minValue="0" maxValue="99999" format="n0" required="true"/></td>
          </tr>
          <tr>
            ...
            <input id="sp2" name="properties['weightId']" class="mini-spinner" style="width:100px" minValue="0" maxValue="99999" format="n3" required="true"/></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 160px;">形状：
            <input id="combo3" class="mini-combobox" name="properties['shapeId']" onvalidation="onComboValidation"
