    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          ...
          <tr>
            <td class="form-label" style="width: 180px;">包装：
            <input id="combo3" class="mini-combobox" name="properties['packageId']" onvalidation="onComboValidation"
              style="width: 105px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${packageEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 240px;">光阻世代：
            <input id="combo3" class="mini-combobox" name="properties['photoResistId']" onvalidation="onComboValidation"
