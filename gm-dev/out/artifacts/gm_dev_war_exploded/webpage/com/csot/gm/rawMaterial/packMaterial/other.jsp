...
<body>
  ...
  <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
    <legend>
      <span>料号生成属性（料号规则-机构-适用于58）</span>
    </legend>
    <table class="form-table" border="0" cellpadding="6" cellspacing="7">
      ...
      <tr>
        ...
        <input id="combo14" class="mini-combobox" name="properties['isRecoveryId']" onvalidation="onComboValidation"
          style="width: 70px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${isRecoveryEnumTypeId}" required=""
        ...
        <input name="properties['reservedCodeId']" id="000" value="00" class="mini-textbox" style="width:75px" allowInput="false"/></td>
