    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 150px;">材质：
          ...
          <tr>
            <td class="form-label" style="width: 150px;">位置：
            <input id="combo5" class="mini-combobox" name="properties['positionId']" onvalidation="onComboValidation"
              style="width: 90px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${positionEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 320px;" colspan="2">ModelName：
            <input id="combo1" class="mini-combobox" name="properties['modelNameId']"
              style="width: 220px;" valueField="id" onvalidation="onComboValidation"
