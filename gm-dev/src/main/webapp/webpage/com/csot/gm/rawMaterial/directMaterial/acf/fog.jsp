      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="7">
          <tr>
            ...
            <td class="form-label" style="width: 200px;">ACF宽度（mm）：
            <input id="combo3" class="mini-combobox" name="properties['widthId']" onvalidation="onComboValidation"
              style="width: 65px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${widthEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 200px;">最小绝缘间距(μm)：
            <input id="combo4" class="mini-combobox" name="properties['miniInsulationId']"
              ...
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">接续面积(μm²)：
            <input id="combo5" class="mini-combobox" name="properties['continuousAreaId']" onvalidation="onComboValidation"
              ...
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">ACF厚度(μm)：
          ...
          <tr>
            ...
            <input id="combopackage" class="mini-combobox" name="properties['packageId']" onvalidation="onComboValidation"
              ...
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">导电粒子直径(μm)：
