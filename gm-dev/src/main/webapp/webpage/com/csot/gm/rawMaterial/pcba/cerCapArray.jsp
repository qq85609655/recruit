...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  ...
  <%@ include file="/webpage/com/csot/gm/rawMaterial/classAndUserInfo.jsp"%>
      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="combo14" class="mini-combobox" name="properties['footDigitId']" onvaluechanged="onDeptChanged('14')"
          ...
          <tr>
            ...
            <input id="combo4" class="mini-combobox" name="properties['ratedVoltageId']"
              style="width: 70px;" valueField="id" onvalidation="onComboValidation" onvaluechanged="onDeptChanged('4')"
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        <span>料号生成属性（料号规则-电子-适用于3406）</span>
      </legend>
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
          ...
          <tr>
            <td class="form-label" style="width: 160px;">脚位数(P)：
            <input id="combo13" class="mini-combobox" name="properties['footDigitId']" onvaluechanged="onDeptChanged('13')"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${footDigitEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">电容值：
  ...
  <script type="text/javascript">
    ...
    function onDeptChanged(e) {
      if (e == "1") {
        ...
        comb14.setValue(comb13.getValue());
      } else if (e == "14") {
        comb13.setValue(comb14.getValue());
      } 
    }
