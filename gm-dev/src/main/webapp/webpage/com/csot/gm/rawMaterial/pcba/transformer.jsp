...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  ...
  <%@ include file="/webpage/com/csot/gm/rawMaterial/classAndUserInfo.jsp"%>
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 240px;">额定电流(A)：
            <input id="combo4" class="mini-combobox" name="properties['ratedCurrentId']" onvalidation="onComboValidation"
              style="width: 145px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${ratedCurrentEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">感值(UH)：
            <input id="combo3" class="mini-combobox" name="properties['inductanceValueId']"
              style="width: 75px;" valueField="id" onvalidation="onComboValidation" 
              url="rawMaterial/getComboData?enumTypeId=${inductanceValueEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 240px;">供应商料号：
            <input id="combo2" class="mini-combobox" name="properties['vendorNoId']"
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        <span>料号生成属性料号生成属性（料号规则-电子-适用于3435）</span>
      </legend>
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
          ...
          <tr>
            ...
            <input id="combo7" class="mini-combobox" name="properties['smallClassId']" onvalidation="onComboValidation"
