      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="sp1" name="properties['outlineLengthId']" class="mini-spinner" style="width:70px" minValue="0" maxValue="99999" format="n3" required="true"/></td>
            ...
            <input id="sp3" name="properties['outlineHeightId']" class="mini-spinner" style="width:100px" minValue="0" maxValue="99999" format="n3" required="true"/></td>
          </tr>
          <tr>
