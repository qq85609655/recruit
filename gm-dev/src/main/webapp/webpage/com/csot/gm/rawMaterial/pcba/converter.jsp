...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  ...
  <%@ include file="/webpage/com/csot/gm/rawMaterial/classAndUserInfo.jsp"%>
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 240px;">ModelName：
            ...
            <td class="form-label" style="width: 140px;">PCB版本号：
            <input id="combo2" class="mini-combobox" name="properties['pcbVersionId']" onvalidation="onComboValidation"
              style="width: 50px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${pcbVersionEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 140px;">PCBA版本号：
            <input id="combo3" class="mini-combobox" name="properties['pcbaVersionId']" onvalidation="onComboValidation"
              style="width: 50px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${pcbaVersionEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>         
        </table>
    </fieldset>
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        <span>料号生成属性（料号规则-电子-适用于3431）</span>
      </legend>
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
          ...
          <tr>
            ...
            <input name="properties['reservedCodeId']" id="0" value="0" class="mini-textbox" style="width:90px" allowInput="false"/></td>
            <td class="form-label" style="width: 160px;">产品编码：
            <input id="combo6" class="mini-combobox" name="properties['productionCodeId']"  onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${productionCodeEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td> 
            <td class="form-label" style="width: 160px;">版本流水号：
            <input id="flowNo" name="properties['flowNoId']" value="XX" class="mini-textbox" style="width:60px" allowInput="false"/></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 160px;">供应商/制别码：
            <input id="combo7" class="mini-combobox" name="properties['systemCodeId']" onvalidation="onComboValidation"
              style="width: 50px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${systemCodeEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
          </tr>
        </table>
