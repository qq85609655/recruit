...
<body>
      ...
      <div id="handlerMainLayout" class="mini-layout" style="width: 100%; height: 100%;">
        <div title="center" region="center" bodyStyle="overflow:hidden;">
          ...
          <ul id="popupMenuExport" class="mini-menu" style="display: none;">
            ...
            <span class="separator"></span>
            <li iconCls="icon-download" onclick="exportPartNoByClass('all')" plain="true">选中分类导出料号</li>
            <span class="separator"></span>
            <li iconCls="icon-download" onclick="exportPartNoById('all')" plain="true">选中料号导出</li>
            <span class="separator"></span>
            <li iconCls="icon-download" onclick="exportPartNoByAnySearch('all')" plain="true">多料号查询结果导出</li>
            <span class="separator"></span>
  ...
  <script>
      ...
      var maskImg = "<div style='border: 5px solid rgba(33,76,89,0.5);background:rgba(255,255,255,0.7) '><img src='resources/images/loader.gif' width='200px'></div>";
      var maskHtml = "<div style='font-size: 25px;'>导出中,请稍后..</div>" + maskImg;
      var maskParam = {
        el: document.body,
      ...
      function exportPartNoById(type) {
        ...
        $.ajax({
          url : hostPath + "partNo/exportPartNoById",
          type : "post",
          data : {
            partNoId : partNoId,
            type : type
      ...
      function exportPartNoByAnySearch(type) {
