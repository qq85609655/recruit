      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <td class="form-label" style="width: 240px;">供应商型号：
            <input id="combo2" class="mini-combobox" name="properties['plantVersionId']" onvalidation="onComboValidation"
              style="width: 150px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${plantVersionEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 200px;">包装：
            <input id="combo3" class="mini-combobox" name="properties['packageId']" onvalidation="onComboValidation"
              style="width: 140px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${packageEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 240px;">光阻世代：
            <input id="combo4" class="mini-combobox" name="properties['photoResistId']" onvalidation="onComboValidation"
              style="width: 160px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${photoResistEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>      
        </table>
    </fieldset>
