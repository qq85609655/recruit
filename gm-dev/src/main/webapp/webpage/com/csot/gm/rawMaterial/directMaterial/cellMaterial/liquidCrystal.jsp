      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <td class="form-label" style="width: 160px;">类型：
          ...
          <tr>
            <td class="form-label" style="width: 160px;">盒厚(um)：
            <input id="combo4" class="mini-combobox" name="properties['thicknessId']"
              ...
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">RM(ppm)：
            <input id="combo5" class="mini-combobox" name="properties['rmId']" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${rmEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
        </table>
    </fieldset>
