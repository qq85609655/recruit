    ...
    <table class="form-table" border="0" cellpadding="3" cellspacing="0">
      ...
      -->
        <td class="form-label" style="width: 230px;">部门： <input id="department"
          requiredErrorText="部门不能为空" name="userInfo.department" class="mini-textbox"
          value="${department}" style="width: 190px" required="true" allowInput="false" /></td>

        <td class="form-label" style="width: 90px;">工号： <input id="userCode" vtype="int"
          requiredErrorText="工号不能为空" name="userInfo.userCode" class="mini-textbox"
          value="${userCode}" style="width: 50px" required="true" onvaluechanged="onValueChanged()" /></td>

        <td class="form-label" style="width: 100px;">姓名： <input id="userName"
          requiredErrorText="姓名不能为空" name="userInfo.userName" class="mini-textbox"
          value="${userName}" style="width: 60px" required="true" allowInput="false" /></td>

        <td class="form-label" style="width: 170px;">联系电话： <input id="telephone"
          requiredErrorText="联系电话不能为空,请填入工号带出信息" name="userInfo.telephone" class="mini-textbox"
          value="${telephone}" style="width: 100px" required="true" allowInput="false" /></td>
      </tr>
        ...
        $.ajax({
          ...
          success : function(data) {
            if (true == data.success) {
              ...
              //默认情况下部门、姓名、联系电话不可编辑,输入工号后联系电话可编辑
