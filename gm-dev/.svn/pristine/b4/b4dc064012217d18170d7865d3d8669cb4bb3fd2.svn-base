      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="sp2" name="properties['outlineLengthId']" class="mini-spinner" style="width:70px" minValue="0" maxValue="99999" format="n3" required="true"/></td>
            <td class="form-label" style="width: 160px;">outline宽(mm)
            <input id="sp2" name="properties['outlineWidthId']" class="mini-spinner" style="width:70px" minValue="0" maxValue="99999" format="n3" required="true"/></td>
            <td class="form-label" style="width: 200px;">outline厚(mm)
            <input id="sp2" name="properties['outlineHeightId']" class="mini-spinner" style="width:100px" minValue="0" maxValue="99999" format="n3" required="true"/></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 160px;">颜色：
            <input id="combo1" class="mini-combobox" name="properties['colorId']" onvalidation="onComboValidation"
            ...
            <input id="combo2" class="mini-combobox" name="properties['suppPropertyId']" value="3" onvalidation="onComboValidation"
