      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          ...
          <tr>
            ...
            <td class="form-label" style="width: 160px;">重量(g)
            <input id="sp2" name="properties['weightId']" class="mini-spinner" style="width:110px" minValue="0" maxValue="99999" format="n0" required="true"/></td>
