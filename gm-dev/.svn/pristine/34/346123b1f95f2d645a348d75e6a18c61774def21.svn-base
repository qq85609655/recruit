      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <td class="form-label" style="width: 190px;">型号：
            <input id="combo2" class="mini-combobox" name="properties['versionId']" onvalidation="onComboValidation"
              style="width: 130px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${versionEnumTypeId}" required="" allowInput="true"
          ...
          <tr>
            ...
            <input id="combo4" class="mini-combobox" name="properties['colorId']"
              ...
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 190px;">Viscosity粘度(Pa*s)：
            <input id="combo5" class="mini-combobox" name="properties['viscosityId']" onvalidation="onComboValidation"
              ...
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">包装规格(kg/瓶)：
