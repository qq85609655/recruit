...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  <div style="width: 700px; margin: 10px" align="center">
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="combo1" class="mini-combobox" name="properties['materialQualityId']" onvalidation="onComboValidation"
              style="width: 100px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${materialQualityEnumTypeId}" 
          ...
          <tr>
            ...
            <td class="form-label" style="width: 160px;">克重(g/m2)
            <input id="sp3" name="properties['weightId']" class="mini-spinner" style="width:90px" minValue="0" maxValue="99999" format="n0" required="true"/></td>
    ...
    <%@ include file="/webpage/com/csot/gm/rawMaterial/packMaterial/label.jsp"%>
