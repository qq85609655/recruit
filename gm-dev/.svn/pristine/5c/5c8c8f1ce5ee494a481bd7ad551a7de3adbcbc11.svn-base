...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  ...
  <%@ include file="/webpage/com/csot/gm/rawMaterial/classAndUserInfo.jsp"%>
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        <span>料号生成属性（料号规则-电子-适用于3430）</span>
      </legend>
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="combo2" class="mini-combobox" name="properties['subClassId']"
            ...
            <input id="combo3" class="mini-combobox" name="properties['classId']"
          ...
          <tr>
            ...
            <td class="form-label" style="width: 160px;">产别码：
            <input id="combo4" class="mini-combobox" name="properties['productionCodeId']" 
