...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  <div style="width: 700px; margin: 10px" align="center">
      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="2">
          <tr>
            ...
            <input id="sp2" name="properties['outlineHeightId']" class="mini-spinner" style="width:110px" minValue="0" maxValue="99999" format="n2" required="true"/></td>
          </tr>
          <tr>
            ...
            <input id="combo2" class="mini-combobox" name="properties['materialQualityId']" onvalidation="onComboValidation"
              style="width: 115px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${materialQualityEnumTypeId}" 
              required="" allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">防静电(Ω)：
            <input id="combo3" class="mini-combobox" name="properties['electrostaticPreventionId']"  onvalidation="onComboValidation"
              style="width: 130px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${electrostaticPreventionEnumTypeId}" 
              required="" allowInput="true" textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 160px;">适用范围：
            <input id="combo4" class="mini-combobox" name="properties['rangeId']" onvalidation="onComboValidation"
              style="width: 90px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${rangeEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">原材厚度(mm)：
            <input id="combo7" class="mini-combobox" name="properties['thicknessId']" onvalidation="onComboValidation"
              style="width: 60px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${thicknessEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            ...
            <tr>
              ...
              <input id="combo6" class="mini-combobox" name="properties['suppPropertyId']" value="3"  onvalidation="onComboValidation"
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
    <legend>
      <span>料号生成属性（料号规则-机构-适用于59）</span>
    </legend>
    <table class="form-table" border="0" cellpadding="6" cellspacing="7">
      <tr>
        ...
        <input id="combobigClass" class="mini-combobox" name="properties['bigClassId']"
          style="width: 65px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${bigClassEnumTypeId}" required=""
      ...
      <tr>
        <td class="form-label" style="width: 140px;">是否回收：
        <input id="combo14" class="mini-combobox" name="properties['isRecoveryId']" onvalidation="onComboValidation"
          style="width: 65px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${isRecoveryEnumTypeId}" required=""
          allowInput="true" textField="text" pinyinField="tag"></td>
