      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="0">
          ...
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['electrostaticPreventionId']" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${electrostaticPreventionEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
            ...
            <td class="form-label" colspan="2" style="width: 200px;">ModelName
            <input id="combo4" class="mini-combobox" name="properties['modelNameId']" onvalidation="onComboValidation"
