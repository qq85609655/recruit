...
<body>
  <div class="mini-fit">
    <form id="mainForm" class="mainform" method="post">
      <input name="id" class="mini-hidden" value="${part.id}" /> <input name="parentId"
        class="mini-hidden" value="${part.parentId}" />
      <table class="formTable" style="table-layout: fixed;">
        <tr>
          ...
          <td class="formContent"><input name="partDesc" class="mini-textbox" required="true"
            value="${part.partDesc}" style="width: 350px" allowInput="true"
