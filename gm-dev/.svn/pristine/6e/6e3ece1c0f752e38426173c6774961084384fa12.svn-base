      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="7">
          ...
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['thicknessId']"
              style="width: 80px;" valueField="id" onvalidation="onComboValidation"
              url="rawMaterial/getComboData?enumTypeId=${thicknessEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 130px;">位置：
            <input id="combo6" class="mini-combobox" name="properties['positionId']"
              style="width: 80px;" valueField="id" onvalidation="onComboValidation"
              url="rawMaterial/getComboData?enumTypeId=${positionEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            <td class="form-label" style="width: 200px;">PCB类型：
            <input id="combo7" class="mini-combobox" name="properties['pcbTypeId']"
              style="width: 135px;" valueField="id" onvalidation="onComboValidation"
              url="rawMaterial/getComboData?enumTypeId=${pcbTypeEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
          </tr>                    
        </table>
    </fieldset>
