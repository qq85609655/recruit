...
<%@ include file="/resources/context/headResource.jsp"%>
  <script src="${basePath}resources/sweetalert/sweetalert.min.js"></script>
  <link rel="stylesheet" type="text/css" href="${basePath}resources/sweetalert/sweetalert.css">
<style>
html, body {
  ...
  <script>
      ...
      function removeRow() {
        ...
        // 删除枚举属性值;
          ...
          swal({
            title: "Are you sure?",
            text: "You will delete this enumValue!",
            type: "warning",
            ...
            closeOnConfirm: false },
              function() {
                SaveData("enumValue/remove/" + enumValueRow.id, "", function (e) {
                  if (e.success) {
                    swal("Deleted!", "Your enumValue has been deleted.", "success");
                  } else {
                    swal("Cancelled", e.message, "error");
                  }
                  enumValueGrid.reload();
                });
              });
            // 删除枚举类及以下的枚举值(检查该枚举类被是否有被用到?)
              ...
              swal({
                    title: "Are you sure?",
                    text: "You will delete your enumType!",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#DD6B55",
                    confirmButtonText: "Yes, delete it!",
                  ...
                  function() {
                    SaveData("enumType/remove/" + enumTypeRow.id, "", function (e) {
                      if (e.success) {
                        swal("Deleted!", "Your enumType has been deleted.", "success");
                      } else {
                        swal("Cancelled", e.msg, "error");
                      }
                      enumTypeGrid.reload();
                    });
                  });
