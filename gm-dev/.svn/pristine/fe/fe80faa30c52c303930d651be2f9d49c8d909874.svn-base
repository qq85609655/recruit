      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <td class="form-label" style="width: 160px;">保管温度：
            <input id="combo3" class="mini-combobox" name="properties['temperatureId']" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${temperatureEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
          <tr>
            ...
            <input id="combo6" class="mini-combobox" name="properties['deadlineId']" onvalidation="onComboValidation"
              ...
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">固化条件：
            <input id="combo7" class="mini-combobox" name="properties['curingConditionId']"
