        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          ...
          <tr>
            ...
            <input id="combo1" class="mini-combobox" name="properties['isRecoveryId']"
              style="width: 85px;" valueField="id" onvaluechanged="onDeptChanged('1')" onvalidation="onComboValidation"
          ...
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['suppPropertyId']" value="3" onvalidation="onComboValidation"
              style="width: 85px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${suppPropertyEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
        </table>
    </fieldset>
