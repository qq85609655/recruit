...
public class GmPartDescRuleMapExtCriteria {
  /**
   * This field was generated by MyBatis Generator.
   * This field corresponds to the database table T_GM_PART_DESC_RULE_MAP
   *
   * @mbggenerated
   */
   ...
   * @mbggenerated
   */
  public GmPartDescRuleMapExtCriteria() {
   ...
   * This class corresponds to the database table T_GM_PART_DESC_RULE_MAP
   *
   * @mbggenerated
   */
