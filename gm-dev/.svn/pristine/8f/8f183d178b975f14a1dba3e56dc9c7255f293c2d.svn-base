      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="7">
          ...
          <tr>
            ...
            <input id="combo4" class="mini-combobox" name="properties['suppPropertyId']" value="3" onvalidation="onComboValidation"
              style="width: 95px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${suppPropertyEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
          </tr>
        </table>
    </fieldset>
