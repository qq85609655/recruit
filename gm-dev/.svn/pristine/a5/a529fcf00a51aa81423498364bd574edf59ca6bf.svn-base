...
<body>
  <form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
    <div style="width: 700px; margin: 10px" align="center">
      ...
      <%@ include file="/webpage/com/csot/gm/sparePartConsumptive/consumptiveGenAttribute.jsp"%>
      <fieldset class="fieldset" id="fd3" style="width: 650px; font-family: 微软雅黑;">
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 224px;">材质： <input id="combo11"
              class="mini-combobox" name="properties['materialQualityId']" style="width: 180px;"
            ...
            <td class="form-label" style="width: 175px;">线径： <input id="combo11"
              class="mini-combobox" name="properties['wireDiameterId']" style="width: 130px;"
              valueField="id" onvalidation="onComboValidation"
              url="rawMaterial/getComboData?enumTypeId=${wireDiameterEnumTypeId}" required=""
              allowInput="true" textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 123px;"></td>
          </tr>
          <tr>
