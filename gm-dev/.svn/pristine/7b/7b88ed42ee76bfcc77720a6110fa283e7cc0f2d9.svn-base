...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  <div style="width: 700px; margin: 10px" align="center">
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          ...
          <tr>
            ...
            <input id="combo2" class="mini-combobox" name="properties['colorId']" onvalidation="onComboValidation"
              style="width: 100px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${colorEnumTypeId}" required="" allowInput="true"
          ...
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['versionId']" onvalidation="onComboValidation"
    ...
    <%@ include file="/webpage/com/csot/gm/rawMaterial/packMaterial/cushion.jsp"%>
