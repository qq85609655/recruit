 ...
 *         &lt;element name="C_LOGINNAME" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
public class ErrorItem {
    ...
    @XmlElement(name = "C_LOGINNAME", required = true, nillable = true)
    protected String cloginname;
    ...
    /**
     * Gets the value of the cloginname property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the cloginname property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCLOGINNAME(String value) {
        this.cloginname = value;
    }
