...
<fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
    <legend>
      <span>料号生成属性（料号规则-备品备件-适用于61）</span>
    </legend>
    <table class="form-table" border="0" cellpadding="6" cellspacing="2">
      <tr>
        ...
        <td class="form-label" style="width: 160px;">厂别码： <input id="combo3"
          ...
          required="" allowInput="false" onvalidation="onComboValidation" textField="text" pinyinField="tag"></td>
      ...
      <tr>
        <td class="form-label" style="width: 160px;">中类： <input id="combo5"
          class="mini-combobox" name="properties['mediumClassId']" style="width: 105px;"
        ...
        <td class="form-label" style="width: 160px;">小类： <input id="combo6"
          class="mini-combobox" name="properties['miniClassId']" style="width: 100px;"
          valueField="id" url="rawMaterial/getComboData?enumTypeId=${miniClassEnumTypeId}"
          required="" allowInput="false" textField="text" pinyinField="tag"></td>
       <td class="form-label" style="width: 160px;">维修区别码：
            <input name="properties['maintainCodeId']" id="0" value="0" class="mini-textbox" style="width:65px" allowInput="false"/></td>
      </tr>
      <tr>
        <td class="form-label" style="width: 160px;">流水码： <input name="properties['flowNoId']"
          value="XXXXXX" class="mini-textbox" style="width: 90px" allowInput="false" /></td>
      </tr>
    </table>
  </fieldset>
</body>
