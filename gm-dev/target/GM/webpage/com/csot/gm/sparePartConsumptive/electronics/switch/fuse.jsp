    ...
    <div style="width: 700px; margin: 10px" align="center">
      ...
      <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 230px;">
            <td class="form-label" style="width: 222px;"></td>
      ...
      <fieldset class="fieldset" id="fd3" style="width: 650px; font-family: 微软雅黑;">
        ...
        <table class="form-table" border="0" cellpadding="6" cellspacing="2">
          <tr>
            <td class="form-label" style="width: 220px;">最大电流： <input id="combo11"
              class="mini-combobox" name="properties['maxCurrentId']" style="width: 150px;"
              valueField="id" onvalidation="onComboValidation"
              url="rawMaterial/getComboData?enumTypeId=${maxCurrentEnumTypeId}" required=""
            ...
            <td class="form-label" style="width: 105px;"></td>
          </tr>
          <tr>
