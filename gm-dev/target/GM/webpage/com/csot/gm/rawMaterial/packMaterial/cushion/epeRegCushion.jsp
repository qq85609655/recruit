      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          ...
          <tr>
            ...
            <input id="combo2" class="mini-combobox" name="properties['colorId']"
          ...
          <tr>
            ...
            <input id="combo4" class="mini-combobox" name="properties['electrostaticPreventionId']" onvalidation="onComboValidation"
              ...
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 160px;">密度(kg/m3)
            <input id="combo5" class="mini-combobox" name="properties['densityId']" onvalidation="onComboValidation"
              style="width: 80px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${densityEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
