...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  ...
  <%@ include file="/webpage/com/csot/gm/rawMaterial/classAndUserInfo.jsp"%>
      ...
      <legend>
        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['ratedVoltageId']" onvalidation="onComboValidation"
              style="width: 75px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${ratedVoltageEnumTypeId}" required="" allowInput="true"
          ...
          <tr>
            <td class="form-label" style="width: 200px;" colspan="2">供应商料号：
    ...
    <fieldset class="fieldset" id="fd2" style="width: 650px; font-family: 微软雅黑;">
      <legend>
        <span>料号生成属性（料号规则-电子-适用于3415）</span>
      </legend>
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          <tr>
            ...
            <input id="combo7" class="mini-combobox" name="properties['classId']" onvalidation="onComboValidation"
