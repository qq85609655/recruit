        ...
        <table class="form-table" border="0" cellpadding="13" cellspacing="2">
          ...
          <tr>
            ...
            <input id="combo5" class="mini-combobox" name="properties['plantVersionId']" onvalidation="onComboValidation"
              ...
              textField="text" pinyinField="tag"></td>
            <td class="form-label" style="width: 200px;">耐温特性：
            <input id="combo6" class="mini-combobox" name="properties['temperatureId']" onvalidation="onComboValidation"
              style="width: 105px;" valueField="id" url="rawMaterial/getComboData?enumTypeId=${temperatureEnumTypeId}" required="" allowInput="true"
              textField="text" pinyinField="tag"></td>
