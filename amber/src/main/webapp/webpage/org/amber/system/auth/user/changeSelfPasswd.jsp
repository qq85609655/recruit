...
<div class="mini-fit">
  <form id="mainForm" class="mainform" method="post">
    ...
    <table class="formTable" style="table-layout: fixed;">
      ...
      <tr>
        <td class="formLabel">当前密码:</td>
        <td class="formContent">
          <input id="oldpassword" name="oldpassword" class="mini-password" required="true"
                 vtype="minLength:3" onvalidation="ValidErrorText"/>
          <label id="oldpassword_error" class="errorText"></label>
        </td>
      </tr>
      <tr>
        <td class="formLabel">新密码:</td>
        <td class="formContent">
          <input id="password" name="password" class="mini-password" required="true"
                 vtype="minLength:3" onvalidation="ValidErrorText"/>
          <label id="password_error" class="errorText"></label>
        </td>
      </tr>
      <tr>
        ...
        <td class="formContent">
          <input id="password2" name="password2" class="mini-password" required="true"
                 vtype="minLength:3" onvalidation="doublePasswordValidation"/>
          <label id="password2_error" class="errorText"></label>
        </td>
      </tr>
    </table>
  </form>
...
<script>
  ...
  function onOk(e) {
    ...
    SaveData("auth/user/sysUser/saveNewSelfPasswd", $("#mainForm").serialize());
  }
