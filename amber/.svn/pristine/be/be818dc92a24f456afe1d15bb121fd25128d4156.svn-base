...
<body>
      ...
      <tr>
        <td>
          ...
          <div id="mainGrid" class="mini-datagrid" style="width: 250px; height: 200px;"
            sizeList="[20,30,50]" pageSize="20" url="auth/user/sysUser/datagrid?showPager=true&status=1"
            idField="id" allowResize="false" multiSelect="true">
            <div property="columns">
              <div type="checkcolumn" width="25"></div>
              <div field="account" width="75" headerAlign="center" allowSort="true">帐号</div>
            </div>
          </div>
        </td>
        ...
        <td>
          ...
          <div id="selectedList" class="mini-listbox" style="width: 250px; height: 200px;"
            ...
            url="auth/group/sysUserGroup/groupMembers/groupId/${groupId}">
            <div property="columns">
              <div field="account" width="75" headerAlign="center" allowSort="true">账号</div>
            </div>
          </div>
        </td>
  ...
  <script>
      ...
      function onOk(e) {
        ...
        SaveData("auth/group/sysUserGroup/save/groupId/${groupId}", {json: json});
      }
