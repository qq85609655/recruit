...
<body>
  <div id="handlerMainLayout" class="mini-layout" style="width: 100%; height: 100%;">
    ...
    <div showHeader="false" region="east" width="400" maxWidth="500" minWidth="300" bodyStyle="overflow:hidden;">
      ...
      <div id="userGrid" class="mini-datagrid" style="width: 100%; height: 100%" treeColumn="name"
        idField="id" url="auth/group/sysUserGroup/groupMembers" allowResize="true" showPager="false">
        <div property="columns">
  ...
  <script>
      ...
      function modify() {
        ...
        if (row) {
          OpenDialog("auth/group/sysGroup/member/modify/" + row.id, "编辑", tree, 650, 400);
        } else {
          ShowWarnTip("请选择一条记录");
        }
      }
