...
/**
 * <p>ESB_ESB_ESB_ImportProcessStatusSrvResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="ESB_ESB_ESB_ImportProcessStatusSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ErrorCollection" type="{http://www.csot.tcl.com/ESB_ESB_ESB_ImportProcessStatusSrv/1.0}ErrorCollection"/>
 *         &lt;element name="ResponseCollection" type="{http://www.csot.tcl.com/ESB_ESB_ESB_ImportProcessStatusSrv/1.0}ResponseCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_ESB_ESB_ImportProcessStatusSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "errorlevel",
...
public class ESBESBESBImportProcessStatusSrvResponse {
