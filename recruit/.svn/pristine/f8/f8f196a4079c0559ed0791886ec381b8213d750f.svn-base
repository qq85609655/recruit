    ...
    <div class="co-right">
      <div class="position-path co-right-center">
        <span class="path-title">您的位置 :</span><a class="path-item a-decoration"
          ...
          class="path-leaf">录用管理-录用</span>
      </div>
      <div class="co-right-main co-right-center">
        <div class="con-title">录用管理-录用</div>
        <div class="main">
              ...
              <div class="blue radius">
                <div class="table-operate">
                  <input type="button" class="button radius btn" id="addRecruitDemand"
                    value="录用申请/修改" onclick="editEmploy()" /> <input type="button"
                    class="button radius btn" id="addRecruitDemand" value="删除" onclick="delEmploy()" />
                  <input type="button" class="button radius btn" id="viewDetail" value="面试评估"
                    onclick="estimateEdit()" /> <input type="button" class="button radius btn"
                    id="editInfo" value="发offer" onclick="sentOffer()" /> <input type="button"
                    class="button radius btn" id="print" value="拒offer" onclick="refuseOffer()" />
                  <input type="button" class="button radius btn" id="print" value="批量解锁"
                    onclick="unlocked()" /> <input type="button" class="button radius btn"
                    id="print" value="发送消息" onclick="sentMessage()" /> <input type="button"
                    class="button radius btn" id="print" value="提醒" onclick="remind()" /> <input
                    type="button" class="button radius btn" id="tagAdd" value="标签"
                ...
                <div id="datagrid1" class="mini-datagrid" oncellclick="cellclick" showPager="true"
                  url="/recruit/employ/datagrid?showPager=true&stage=1" ondrawcell="ondrawcell"
