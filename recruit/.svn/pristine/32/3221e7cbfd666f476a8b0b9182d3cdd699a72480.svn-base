	...
	<div class="co">
		...
		<div class="co-right">
			<div class="position-path co-right-center">
				...
				<em class="path-icon">&gt;&gt;</em><span class="path-leaf">批量导入记录</span>
			</div>
			<div class="co-right-main co-right-center">
				<div class="con-title">本地上传记录</div>
				<div class="main">
...
<script type="text/javascript" src="${webRoot}/resources/js/importMultipleResumeRecord.js"></script>
</html>