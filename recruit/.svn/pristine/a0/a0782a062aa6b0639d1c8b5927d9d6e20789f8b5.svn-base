...
<body onload="removeLoad();">
                ...
                <table class="form-table" border="0" cellpadding="10" cellspacing="10">
                  <tr>
                    ...
                    <td style="width: 240px;"><input id="demandId" name="demandId"
                      ...
                      required="true" /><span class="copy-posi" onclick="choseDemand()"> <span
                        class="font-icon icon-reply-all" title="选择岗位"></span>选择需求
                    </span></td>
                ...
                <table class="form-table" border="0" cellpadding="30" cellspacing="30">
                  <tr>
                    ...
                    <td style="width: 250px;"><input id="employmentForm" name="employmentForm"
                      readonly="readonly" class="mini-textbox" value="${employ.employmentForm}" /><span
                      class="copy-posi" onclick="choseInterview()"> <span
                        class="font-icon icon-reply-all" title="选择申请表"></span>选择申请表
                    </span></td>
                  ...
                  <tr>
                    ...
                    <td><input class="mini-radiobuttonlist" textField="typeName"
                      ...
                      requiredErrorText="性别不能为空" value="${employCandidate.isBeidiao}"
                  ...
                  <tr>
                    ...
                    <td><input name="email" id="email" class="mini-textbox" required="true"
                      vtype="email" value="${employCandidate.email}" /></td>
                  </tr>
                  <tr>
                    ...
                    <c:if test="${employCandidate.candidateType ne '0' }">
                    ...
                    <c:if test="${employCandidate.candidateType eq '0' }">
                      <td><input id="employRankId" class="mini-combobox" name="employRankId"
                        valueField="typeCode" required="true" textField="typeName"
                        value="${employCandidate.employRankId}"
                  ...
                  <tr>
                    ...
                    <td><input name="candidatePostName" id="candidatePostName"
                      ...
                      value="${employCandidate.candidatePostName}" /><span class="copy-posi"
                      onclick="choseJob()"> <span class="font-icon icon-reply-all"
                  ...
                  <tr>
                    ...
                    <td><input class="mini-radiobuttonlist" textField="typeName"
                      ...
                      data="[{typeCode:0,typeName:'是'},{typeCode:1,typeName:'否'}]" /></td>
                        ...
                        <tr>
                          <td class="form-label"><span class="copy-posi"
                            onclick="removeTableJy(${i})"><span
                              class="font-icon icon-remove-new" title="移除"></span>移除 </span></td>
                        </tr>
                      </c:if>
                    </table>
                  </c:forEach>
  ...
  <script type="text/javascript" src="${webRoot}/resources/js/flow/employ/employEdit.js?v=2"></script>
