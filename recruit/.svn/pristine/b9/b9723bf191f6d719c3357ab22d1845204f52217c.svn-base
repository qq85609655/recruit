...
/**
 * <p>ESB_GYD_GYD_InquiryParseContentSrvOutputItem complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryParseContentSrvOutputItem">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="CONTENT_TYPE" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="CONTENT_LENGTH" type="{http://www.w3.org/2001/XMLSchema}decimal"/>
 *         &lt;element name="BINARY_CONTENT" type="{http://www.w3.org/2001/XMLSchema}base64Binary"/>
 *         &lt;element name="ASCII_CONTENT" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "ESB_GYD_GYD_InquiryParseContentSrvOutputItem", propOrder = {
    "contenttype",
    "contentlength",
    "binarycontent",
    "asciicontent",
...
public class ESBGYDGYDInquiryParseContentSrvOutputItem {

    @XmlElement(name = "CONTENT_TYPE", required = true, nillable = true)
    protected String contenttype;
    @XmlElement(name = "CONTENT_LENGTH", required = true, nillable = true)
    protected BigDecimal contentlength;
    @XmlElement(name = "BINARY_CONTENT", required = true, nillable = true)
    protected byte[] binarycontent;
    @XmlElement(name = "ASCII_CONTENT", required = true, nillable = true)
    protected String asciicontent;
     ...
     *     
     */
    public void setCONTENTLENGTH(BigDecimal value) {
     ...
     *     
     */
    public void setASCIICONTENT(String value) {
        this.asciicontent = value;
    }
