...
/**
 * <p>ESB_GYD_GYD_InquiryAccountExtraSrvOutputItem complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryAccountExtraSrvOutputItem">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryAccountExtraSrvOutputItem", propOrder = {
    "contenttype",
    "contentlength",
    "binarycontent",
    "asciicontent",
...
public class ESBGYDGYDInquiryAccountExtraSrvOutputItem {
