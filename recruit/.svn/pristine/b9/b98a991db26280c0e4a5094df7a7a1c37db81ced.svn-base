...
/**
 * <p>ESB_GYD_GYD_InquiryFunctionsSrvRequest complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryFunctionsSrvRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryFunctionsSrvRequest", propOrder = {
    "msgHeader",
    "paramaters",
    "postdata",
    "resulttype",
...
public class ESBGYDGYDInquiryFunctionsSrvRequest {
