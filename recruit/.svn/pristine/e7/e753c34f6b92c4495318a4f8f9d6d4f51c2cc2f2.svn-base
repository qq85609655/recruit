              ...
              <table class="jobEdit-tab">
                ...
                <tbody>
                  ...
                  <tr class="jobEdit-tr">
                    ...
                    <c:if test="${recruitDemand.employeeType ne '0' }">
                     <td style="display: none;">
                      <%-- <t:dictSelect type="select" id="positionLevel" field="position-level"
                        typeGroupCode="position-level" defaultVal="0" hasLabel="false"></t:dictSelect> --%>
                      <input id="positionLevel" class="mini-combobox" name="positionLevel"
                        cls="asLabel" readonly="readonly" valueField="typeCode" textField="typeName"
                        value="${post.positionLevel}"
                  ...
                  <tr class="jobEdit-tr">
                    ...
                    <td><input name="trench" class="mini-checkboxlist" id="trench"  onvaluechanged="checkRecruitType"
