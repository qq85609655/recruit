...
/**
 * <p>ESB_GYD_GYD_InquiryParseDocumentSrvOutputItem complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryParseDocumentSrvOutputItem">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryParseDocumentSrvOutputItem", propOrder = {
    "contenttype",
    "contentlength",
    "binarycontent",
    "asciicontent",
...
public class ESBGYDGYDInquiryParseDocumentSrvOutputItem {
