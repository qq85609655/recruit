...
/**
 * <p>ESB_GYD_GYD_InquiryFunctionsSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryFunctionsSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryFunctionsSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryFunctionsSrv/1.0}ESB_GYD_GYD_InquiryFunctionsSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryFunctionsSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryFunctionsSrvOutputCollection"
})
public class ESBGYDGYDInquiryFunctionsSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryFunctionsSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryFunctionsSrvOutputCollection esbgydgydInquiryFunctionsSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryFunctionsSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryFunctionsSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryFunctionsSrvOutputCollection getESBGYDGYDInquiryFunctionsSrvOutputCollection() {
        return esbgydgydInquiryFunctionsSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryFunctionsSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryFunctionsSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryFunctionsSrvOutputCollection(ESBGYDGYDInquiryFunctionsSrvOutputCollection value) {
        this.esbgydgydInquiryFunctionsSrvOutputCollection = value;
    }
