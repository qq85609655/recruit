...
/**
 * <p>ESB_GYD_GYD_InquiryParseMailSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryParseMailSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryParseMailSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryParseMailSrv/1.0}ESB_GYD_GYD_InquiryParseMailSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryParseMailSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryParseMailSrvOutputCollection"
})
public class ESBGYDGYDInquiryParseMailSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryParseMailSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryParseMailSrvOutputCollection esbgydgydInquiryParseMailSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryParseMailSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryParseMailSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryParseMailSrvOutputCollection getESBGYDGYDInquiryParseMailSrvOutputCollection() {
        return esbgydgydInquiryParseMailSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryParseMailSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryParseMailSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryParseMailSrvOutputCollection(ESBGYDGYDInquiryParseMailSrvOutputCollection value) {
        this.esbgydgydInquiryParseMailSrvOutputCollection = value;
    }
