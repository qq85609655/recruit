...
public class CampusAddressbookExt implements Serializable {
    private String id;
    ...
    public boolean equals(Object that) {
        ...
        CampusAddressbookExt other = (CampusAddressbookExt) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCampusRole() == null ? other.getCampusRole() == null : this.getCampusRole().equals(other.getCampusRole()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCampusRole() == null) ? 0 : getCampusRole().hashCode());
