 ...
 *       &lt;sequence>
 *         &lt;element name="FLOW_ID" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="FLOW_NO" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
public class ResponseItem {
    ...
    @XmlElement(name = "FLOW_ID", required = true, nillable = true)
    protected String flowid;
    @XmlElement(name = "FLOW_NO", required = true, nillable = true)
