...
<body>
          ...
          <div class="blue radius">
            <div class="table-operate">
              <input type="button" class="button radius btn" id="create" value="新增"
                ...
                id="remove" value="删除" onclick="removeMessageTemplate()" /> <input id="key" class="mini-textbox"
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript" src="${webRoot}/resources/js/templateManage/messageTemplateList.js"></script>
</body>
</html>