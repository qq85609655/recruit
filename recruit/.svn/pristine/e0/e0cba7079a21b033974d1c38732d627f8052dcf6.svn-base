...
<body>
  <div class="mini-fit">
    <form id="mainForm" class="mainform" AutoScroll="true" method="post">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            ...
            requiredErrorText="工作地点不能为空" /> --%> <input name="workingPlace" class="mini-combobox"
            id="workPlaceId" valueField="typeId" textField="typeName" style="width: 180px"
            onvalidation="onWorkPlaceValidation" value="${campusStudent.workingPlace}"
            onvaluechanged="onWorkPlaceChanged"
      ...
      <table>
        ...
        <tr>
          <td>姓名</td>
          <td><input name="realname" class="mini-textbox" required="true"
      ...
      <table>
        ...
        <tr>
          <td>违约情况&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          <td><input id="radioButtom8" name="breakOff" class="mini-radiobuttonlist"
            value="${campusStudent.breakOff }" url="/recruit/resources/data/yesOrNo.txt"
            textField="text" valueField="id" /></td>
        </tr>
      </table>
    </form>
  ...
  <script type="text/javascript" src="${basePath}/resources/js/campus/campusStuEdit.js"></script>
