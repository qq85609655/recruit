...
/**
 * <p>ESB_GYD_GYD_InquiryPostingExtraSrvRequest complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryPostingExtraSrvRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryPostingExtraSrvRequest", propOrder = {
    "msgHeader",
    "paramaters",
    "postdata",
    "resulttype",
...
public class ESBGYDGYDInquiryPostingExtraSrvRequest {
