...
public class LogController {
    ...
    public ModelAndView list() {
        return new ModelAndView("com/csot/recruit/controller/log/logList");
    }
    ...
    public ModelAndView create() {
        return new ModelAndView("com/csot/recruit/controller/log/logEdit");
    }
    ...
    public ModelAndView view(@PathVariable String id, HttpServletRequest request) {
        Log log = logService.getByPrimaryKey(id);
        request.setAttribute("log", log);
        return new ModelAndView("com/csot/recruit/controller/log/logView");
    }
