...
/**
 * <p>ESB_GYD_GYD_InquiryCaptchaSrvOutputItem complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryCaptchaSrvOutputItem">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryCaptchaSrvOutputItem", propOrder = {
    "contenttype",
    "contentlength",
    "binarycontent",
    "asciicontent",
...
public class ESBGYDGYDInquiryCaptchaSrvOutputItem {
