...
/**
 * <p>ESB_GYD_GYD_InquiryHasCaptchaSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryHasCaptchaSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryHasCaptchaSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryHasCaptchaSrv/1.0}ESB_GYD_GYD_InquiryHasCaptchaSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryHasCaptchaSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryHasCaptchaSrvOutputCollection"
})
public class ESBGYDGYDInquiryHasCaptchaSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryHasCaptchaSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryHasCaptchaSrvOutputCollection esbgydgydInquiryHasCaptchaSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryHasCaptchaSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryHasCaptchaSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryHasCaptchaSrvOutputCollection getESBGYDGYDInquiryHasCaptchaSrvOutputCollection() {
        return esbgydgydInquiryHasCaptchaSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryHasCaptchaSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryHasCaptchaSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryHasCaptchaSrvOutputCollection(ESBGYDGYDInquiryHasCaptchaSrvOutputCollection value) {
        this.esbgydgydInquiryHasCaptchaSrvOutputCollection = value;
    }
