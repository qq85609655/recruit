            ...
            <table class="position-import-tab1">
              <tr>
                <td>
                  ...
                  <button class="posi-import-btn blue tab-up" id="detail-button4"
            ...
            <div class="account-content">
              ...
              <div class="blue radius">
                ...
                <div id="datagrid1" class="mini-datagrid" oncellclick="cellclick" showPager="true"
                  url="/recruit/employ/datagrid?showPager=true&stage=5" ondrawcell="ondrawcell"
...
<script type="text/javascript" src="${webRoot}/resources/js/flow/employ/employList.js?v=4"></script>
</html>
