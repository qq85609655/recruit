...
/**
 * <p>ESB_GYD_GYD_InquiryPostJobsSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryPostJobsSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryPostJobsSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryPostJobsSrv/1.0}ESB_GYD_GYD_InquiryPostJobsSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryPostJobsSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryPostJobsSrvOutputCollection"
})
public class ESBGYDGYDInquiryPostJobsSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryPostJobsSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryPostJobsSrvOutputCollection esbgydgydInquiryPostJobsSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryPostJobsSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryPostJobsSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryPostJobsSrvOutputCollection getESBGYDGYDInquiryPostJobsSrvOutputCollection() {
        return esbgydgydInquiryPostJobsSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryPostJobsSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryPostJobsSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryPostJobsSrvOutputCollection(ESBGYDGYDInquiryPostJobsSrvOutputCollection value) {
        this.esbgydgydInquiryPostJobsSrvOutputCollection = value;
    }
