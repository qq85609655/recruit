  ...
  <body>
       <div style="text-align: center;">
         <div style=" padding-top: 40px;padding-left:150px;">
          <form action="" id="estimateForm" style="text-align: center;">
          ...
          <table id="mytable" cellspacing="0" align="center">
            ...
            <tr>
             ...
             <tr>
              ...
              <td colspan="3">${estimate.orgComment } </td>
            </tr>
          </table>
          </form>
          </div>
