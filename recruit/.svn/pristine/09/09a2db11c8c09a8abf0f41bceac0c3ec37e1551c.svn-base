...
/**
 * <p>ESB_GYD_GYD_InquiryFunctionMappingSrvRequest complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryFunctionMappingSrvRequest">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="MsgHeader" type="{http://www.csot.tcl.com/MsgHeader/1.0}MsgHeader"/>
 *         &lt;element name="PARAMATERS" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="POST_DATA" type="{http://www.w3.org/2001/XMLSchema}string"/>
 ...
 *         &lt;element name="FUNCTION_ID" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "ESB_GYD_GYD_InquiryFunctionMappingSrvRequest", propOrder = {
    "msgHeader",
    "paramaters",
    "postdata",
    "resulttype",
...
public class ESBGYDGYDInquiryFunctionMappingSrvRequest {

    @XmlElement(name = "MsgHeader", required = true)
    protected MsgHeader msgHeader;
    @XmlElement(name = "PARAMATERS", required = true, nillable = true)
    protected String paramaters;
    @XmlElement(name = "POST_DATA", required = true, nillable = true)
    protected String postdata;
    @XmlElement(name = "RESULT_TYPE", required = true, nillable = true)
    protected String resulttype;
    @XmlElement(name = "SITE", required = true, nillable = true)
    protected String site;
    @XmlElement(name = "FUNCTION_ID", required = true, nillable = true)
     ...
     *     
     */
    public void setPARAMATERS(String value) {
        this.paramaters = value;
    }
