...
<body onload="removeLoad();">
      ...
      <div class="co-right-main co-right-center">
        <div class="blue radius">
          <div id="handlerMainLayout" class="mini-layout" style="width: 100%; height: 360px;">
                ...
                <table style="width: 100%;">
                  <tr>
                    ...
                    <td style="white-space: nowrap; padding-right: 8px;"><input id="searchKey"
                      class="mini-textbox" onenter="onKeyEnter" emptyText="请输入部门名称" selectOnFocus="true" />
            ...
            <div showHeader="false" region="east" width="300" maxWidth="500" minWidth="200"
                ...
                <table style="width: 100%;">
                  <tr>
                    ...
                    <td style="white-space: nowrap; padding-right: 8px;"><input id="searchJobKey"
                      class="mini-textbox" onenter="onKeyEnter" emptyText="请输入岗位名称" selectOnFocus="true" />
                      <a class="mini-button" iconCls="icon-search" plain="true" onclick="searchJob">查询</a></td>
                  </tr>
                </table>
              </div>
              <div id="jobGird" class="mini-datagrid" style="width: 100%; height: 100%" treeColumn="name"
                idField="id" url="/recruit/jobController/datagrid" allowResize="true" showPager="false">
                <div property="columns">
  ...
  <script>
      ...
      function onOk() {
        $.ajax({
          url : basePath + "/candidateRecommendController/changePostionRecommend",
          type : "post",
          data:{id:"${id}",
            positionId:jobGird.getSelected().cJobcode},
          dataType: "json",
