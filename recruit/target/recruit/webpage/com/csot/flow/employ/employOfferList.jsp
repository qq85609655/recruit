    ...
    <div class="co-right">
      <div class="position-path co-right-center">
        <span class="path-title">您的位置 :</span><a class="path-item a-decoration"
          ...
          class="path-leaf">录用管理-offer</span>
      </div>
      <div class="co-right-main co-right-center">
        <div class="con-title">录用管理-offer</div>
        <div class="main">
            ...
            <table class="position-import-tab1">
              <tr>
                <td>
                  ...
                  <button class="posi-import-btn blue tab-up" id="detail-button1"
                  ...
                  <button class="posi-import-btn blue " id="detail-button3"
            ...
            <div class="account-content">
              ...
              <div class="blue radius">
                <div class="table-operate">
                  <input type="button" class="button radius btn" id="print" value="发送消息"
                    onclick="sentMessage()" /> <input type="button" class="button radius btn"
                    id="remind" value="提醒" onclick="remind()" /> <input type="button"
                    class="button radius btn" id="tagAdd" value="标签" onclick="addTag()" /> <input
                    type="button" class="button radius btn" id="print" value="入职" onclick="entry()" />
                  <input type="button" class="button radius btn" id="print" value="放弃入职"
                    onclick="refuseEntry()" /> <input type="button" class="button radius btn"
                    id="print" value="黑名单" onclick="inBlacklist()" />
                </div>
                <div id="datagrid1" class="mini-datagrid" oncellclick="cellclick" showPager="true"
                  url="/recruit/employ/datagrid?showPager=true&stage=2" idField="id"
                  ondrawcell="ondrawcell" sizeList="[1,2,50,100]" pageSize="10" allowResize="false"
                  multiSelect="true">
                  <div property="columns">
                    ...
                    <div name="offerDate" field="offerDate" width="60" allowSort="false"
                      align="center" dateFormat="yyyy-MM-dd" headerAlign="center">发送offer时间</div>
