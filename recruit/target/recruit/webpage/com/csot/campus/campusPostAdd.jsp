...
<form id="form1" class="fieldset-body" method="post" enctype="multipart/form-data">
  ...
  <div style="width: 700px; margin: 10px" align="center">
    <table class="form-table" border="0" align="center">
      <tr>
        <td class="form-label" style="width: 215px">职位族<span style="color: red">*</span>：
          <input id="jobFamily" class="mini-combobox" name="jobFamily"
                 value="${campusPost.jobFamily}" style="width: 120px;" valueField="typeId"
        ...
        <td class="form-label" style="width: 215px">岗位名称<span style="color: red">*</span>： <input
                id="postId" class="mini-combobox" name="postId" value="${campusPost.postId}"
                onvaluechanged="onPostChanged()" style="width: 120px;" valueField="typeId"
                onvalidation="onComboValidation"
                url="/recruit/datadictGroupTypeController/getDictsByCode/pose_type" required="true"
      ...
      <table class="form-table" border="0" cellpadding="10" cellspacing="10">
        <tr>
          ...
          <td><input name="bigCenter" class="mini-textbox" required="true"
                     value="${campusPost.bigCenter}"/></td>
          <td class="form-label">需求小中心<font style="color: red">*</font>：
          </td>
        ...
        <tr>
          ...
          <td><input id="jobClass" name="jobClass" class="mini-textbox"
                     value="${campusPost.jobClass}"
                     required="true"/></td>
    ...
    <fieldset class="fieldset" id="fd2"
      ...
      <table class="form-table" border="0" cellpadding="10" cellspacing="10">
        ...
        <tr>
          ...
          <td class="form-label">备选专业<font style="color: red">*</font>：
          </td>
