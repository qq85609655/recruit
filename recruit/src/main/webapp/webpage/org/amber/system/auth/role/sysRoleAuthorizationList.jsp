...
<jsp:include page="/webpage/header.jsp"></jsp:include>
  ...
  <div class="co">
    ...
    <div class="co-right">
      <div class="position-path co-right-center">
        ...
        <em class="path-icon">&gt;&gt;</em>
        <span class="path-leaf">角色权限列表</span>
      </div>
      <div class="co-right-main co-right-center">
        <div class="con-title">角色权限列表</div>
        <div class="blue radius">
          
          <div id="RoleMainLayout" class="mini-layout" style="width: 100%; height:600px;">
            <div title="角色列表" region="center" showHeader="true" showCollapseButton="false"
              ...
              <div class="mini-fit">
                <div id="roleGrid" class="mini-datagrid" style="width: 100%; height: 100%"
                  sizeList="[20,30,50]" pageSize="20" url="/recruit/auth/role/sysRole/datagrid?showPager=true"
  ...
  <script>
      ...
      roleGrid.on("selectionchanged", function(e) {
        var role = e.selected;
        resourceTree.load("/recruit/auth/resource/sysRoleResource/resource/checkedTree/"
            + role.id);
      ...
      function saveMenu() {
        ...
        if (role) {
          ...
          SaveData("/recruit/auth/resource/sysRoleResource/saveMenu/roleId/" + role.id,
              {
                json : json
              }, ShowActionTip);
        } else {
      ...
      function reloadCheckedMenu() {
        ...
        if (role) {
          resourceTree
              .load("/recruit/auth/resource/sysRoleResource/resource/checkedTree/"
                  + role.id);
        }
      }
      ...
      function editPermission() {
        ...
        if (role != null && resource != null) {
          OpenDialog("/recruit/auth/permission/sysRoleResourcePermission/modify/roleId/"
      ...
      function loadPermissionList(roleId, resourceId) {
        permissionList
            .load("/recruit/auth/permission/sysRoleResourcePermission/roleResourcePerms/roleId/"
