...
<div class="co">
    ...
    <div class="co-right">
      <div class="position-path co-right-center">
        ...
        <em class="path-icon">&gt;&gt;</em>
        <span class="path-leaf">组成员列表</span>
      </div>
      <div class="co-right-main co-right-center">
        <div class="con-title">组成员列表</div>
        <div class="blue radius">
          ...
          <div id="handlerMainLayout" class="mini-layout" style="width: 100%; height: 600px;">
                ...
                <table style="width: 100%;">
                  <tr>
                    <td style="width: 100%;"><a class="mini-button" iconCls="icon-edit"
                      onclick="modify" plain="true">编辑成员</a></td>
            ...
            <div showHeader="false" region="east" width="400" maxWidth="500" minWidth="300" bodyStyle="overflow:hidden;">
              <div id="userGrid" class="mini-datagrid" style="width: 100%; height: 100%" treeColumn="name"
                idField="id" url="/recruit/auth/group/sysUserGroup/groupMembers" allowResize="true" showPager="false">
                <div property="columns">
                  <div field="account" width="60" headerAlign="center" allowSort="true">帐号</div>
                  <div field="status" width="40" headerAlign="center" renderer="onStatusRenderer">状态</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
      ...
      function modify() {
        ...
        if (row) {
          OpenDialog("/recruit/auth/group/sysGroup/member/modify/" + row.id, "编辑", tree, 650, 400);
        } else {
          ShowWarnTip("请选择一条记录");
        }
      }
