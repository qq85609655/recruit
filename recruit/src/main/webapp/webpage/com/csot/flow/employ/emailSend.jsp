...
<body>
      ...
      <table class="form-table">
        <tr>
          ...
          <td><input id="realName" value="${realName }" name="realName" class="mini-textbox"
            required="true" /> <input id="candidateId" value="${candidateId}" name="candidateId" class="mini-hidden" /></td>
  ...
  <script type="text/javascript" src="${webRoot}/resources/js/flow/employ/campusStuEmailSendByDef.js?v=2"></script>
</body>
</html>