    ...
    <div class="co-right">
      <div class="position-path co-right-center">
        <span class="path-title">您的位置 :</span><a class="path-item a-decoration"
          ...
          class="path-leaf">全部日程</span>
      </div>
      <div class="co-right-main co-right-center">
        <div class="con-title">全部日程</div>
        <div class="main">
            ...
            <div class="account-content">
              ...
              <div class="blue radius">
                ...
                <div id="datagrid1" class="mini-datagrid" oncellclick="cellclick" showPager="true"
                  url="/recruit/postWebsiteLog/datagrid?showPager=true" idField="id"
                  ...
                  <div property="columns">
                    ...
                    <div name="beforeState" field="beforeState" width="100" allowSort="true"
                      align="center" headerAlign="center">操作前状态</div>
                    <div name="state" field="state" width="100" allowSort="true" align="center"
                      headerAlign="center">操作后状态</div>
                    ...
                    <div name="lastInstruct" field="lastInstruct" width="80" allowSort="true"
                      align="center" headerAlign="center">操作指令类型</div>
...
<script type="text/javascript" src="${webRoot}/resources/js/flow/websitePost/websitePostLogList.js"></script>
</html>
