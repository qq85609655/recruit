    ...
    <div class="co-right">
      <div class="position-path co-right-center">
        <span class="path-title">您的位置 :</span><a class="path-item a-decoration"
          ...
          class="path-item a-decoration">经理人</a><em class="path-icon">&gt;&gt;</em><span
              ...
              <div class="blue radius">
                <div class="table-operate">
                  <input type="button" class="button radius btn" id="addRecruitDemand"
                    ...
                    onclick="updateRecruitDemandByHandler()" />
                </div>
                <div id="datagrid1" class="mini-datagrid" oncellclick="cellclick" showPager="true"
                  ondrawcell="ondrawcell"
                  url="/recruit/demand/datagridByHandler?showPager=true&demandState=${demandState}"
                  showEmptyText="true" emptyText="暂无匹配数据" idField="id" sizeList="[1,2,50,100]"
                  ...
                  <div property="columns">
                    ...
                    <div name="recommendNumber" field="recommendNumber" width="60" allowSort="false"
                      align="center" headerAlign="center">推荐的简历</div>
                    ...
                    <div name="flowDate" field="flowDate" width="80" allowSort="false"
                      align="center" headerAlign="center">流程发布日期</div>
                  </div>
                </div>
              </div>
...
<script type="text/javascript"
  src="${webRoot}/resources/js/flow/recruitdemand/recruitDemandList.js?v=2"></script>
</html>
