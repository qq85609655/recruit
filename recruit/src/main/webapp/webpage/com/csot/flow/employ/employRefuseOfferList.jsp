    ...
    <div class="co-right">
      <div class="position-path co-right-center">
        <span class="path-title">您的位置 :</span><a class="path-item a-decoration"
          ...
          class="path-leaf">录用管理-拒offer</span>
      </div>
      <div class="co-right-main co-right-center">
        <div class="con-title">录用管理-拒offer</div>
        <div class="main">
            ...
            <table class="position-import-tab1">
              <tr>
                <td>
                  ...
                  <button class="posi-import-btn blue tab-up" id="detail-button2"
            ...
            <div class="account-content">
              ...
              <div class="blue radius">
                ...
                <div id="datagrid1" class="mini-datagrid" oncellclick="cellclick" showPager="true"
                  url="/recruit/employ/datagrid?showPager=true&stage=3" idField="id"
                  ...
                  <div property="columns">
                    ...
                    <div name="refuseReason" field="refuseReason" width="60" allowSort="false"
                      cellCls="color-blue curpo" align="center" dateFormat="yyyy-MM-dd"
                      headerAlign="center">拒offer原因</div>
