    ...
    <div class="basic-infor body-co">
      <div class="basic-infor-left">
        ...
        <div class="basic-infor-co">
          <div class="tr-h">
            <span class="resume-name" id="resumeName">${resumeVo.name}</span>(<span id="resumeGender">${resumeVo.sex}</span> <span id="resumeAge">${resumeVo.age}</span>岁 <span id="resumeEdu">${resumeVo.highestEducation}</span>)
          </div>
          <div class="tr">
...
var curName = '<shiro:principal type="java.lang.String"/>';
  ...
  <script type="text/javascript" src="${webRoot}/resources/js/candidate/candidateResumeList.js"></script>
