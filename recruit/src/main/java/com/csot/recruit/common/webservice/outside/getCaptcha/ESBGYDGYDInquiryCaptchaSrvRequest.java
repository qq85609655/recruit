...
/**
 * <p>ESB_GYD_GYD_InquiryCaptchaSrvRequest complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryCaptchaSrvRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryCaptchaSrvRequest", propOrder = {
    "msgHeader",
    "paramaters",
    "postdata",
    "resulttype",
...
public class ESBGYDGYDInquiryCaptchaSrvRequest {
