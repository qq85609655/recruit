...
/**
 * <p>ESB_GYD_GYD_InquiryParseMailSrvRequest complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryParseMailSrvRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryParseMailSrvRequest", propOrder = {
    "msgHeader",
    "paramaters",
    "postdata",
    "resulttype",
...
public class ESBGYDGYDInquiryParseMailSrvRequest {
