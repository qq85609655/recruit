...
/**
 * <p>ESB_GYD_GYD_InquiryParseContentSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryParseContentSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryParseContentSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryParseContentSrv/1.0}ESB_GYD_GYD_InquiryParseContentSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryParseContentSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryParseContentSrvOutputCollection"
})
public class ESBGYDGYDInquiryParseContentSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryParseContentSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryParseContentSrvOutputCollection esbgydgydInquiryParseContentSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryParseContentSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryParseContentSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryParseContentSrvOutputCollection getESBGYDGYDInquiryParseContentSrvOutputCollection() {
        return esbgydgydInquiryParseContentSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryParseContentSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryParseContentSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryParseContentSrvOutputCollection(ESBGYDGYDInquiryParseContentSrvOutputCollection value) {
        this.esbgydgydInquiryParseContentSrvOutputCollection = value;
    }
