...
/**
 * <p>ESB_GYD_GYD_InquiryAccountExtraSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryAccountExtraSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryAccountExtraSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryAccountExtraSrv/1.0}ESB_GYD_GYD_InquiryAccountExtraSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryAccountExtraSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryAccountExtraSrvOutputCollection"
})
public class ESBGYDGYDInquiryAccountExtraSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryAccountExtraSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryAccountExtraSrvOutputCollection esbgydgydInquiryAccountExtraSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryAccountExtraSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryAccountExtraSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryAccountExtraSrvOutputCollection getESBGYDGYDInquiryAccountExtraSrvOutputCollection() {
        return esbgydgydInquiryAccountExtraSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryAccountExtraSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryAccountExtraSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryAccountExtraSrvOutputCollection(ESBGYDGYDInquiryAccountExtraSrvOutputCollection value) {
        this.esbgydgydInquiryAccountExtraSrvOutputCollection = value;
    }
