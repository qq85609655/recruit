...
/**
 * <p>ESB_GYD_GYD_InquiryAccountExtraSrvRequest complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryAccountExtraSrvRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryAccountExtraSrvRequest", propOrder = {
    "msgHeader",
    "paramaters",
    "postdata",
    "resulttype",
...
public class ESBGYDGYDInquiryAccountExtraSrvRequest {
