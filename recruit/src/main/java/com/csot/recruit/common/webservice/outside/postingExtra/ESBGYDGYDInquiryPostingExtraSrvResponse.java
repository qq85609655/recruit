...
/**
 * <p>ESB_GYD_GYD_InquiryPostingExtraSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryPostingExtraSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryPostingExtraSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryPostingExtraSrv/1.0}ESB_GYD_GYD_InquiryPostingExtraSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryPostingExtraSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryPostingExtraSrvOutputCollection"
})
public class ESBGYDGYDInquiryPostingExtraSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryPostingExtraSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryPostingExtraSrvOutputCollection esbgydgydInquiryPostingExtraSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryPostingExtraSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryPostingExtraSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryPostingExtraSrvOutputCollection getESBGYDGYDInquiryPostingExtraSrvOutputCollection() {
        return esbgydgydInquiryPostingExtraSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryPostingExtraSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryPostingExtraSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryPostingExtraSrvOutputCollection(ESBGYDGYDInquiryPostingExtraSrvOutputCollection value) {
        this.esbgydgydInquiryPostingExtraSrvOutputCollection = value;
    }
