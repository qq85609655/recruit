...
/**
 * <p>ESB_GYD_GYD_InquiryParseMailSrvOutputItem complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryParseMailSrvOutputItem">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryParseMailSrvOutputItem", propOrder = {
    "contenttype",
    "contentlength",
    "binarycontent",
    "asciicontent",
...
public class ESBGYDGYDInquiryParseMailSrvOutputItem {
