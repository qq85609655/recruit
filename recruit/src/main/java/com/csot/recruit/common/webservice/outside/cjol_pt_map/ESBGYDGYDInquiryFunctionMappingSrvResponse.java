...
/**
 * <p>ESB_GYD_GYD_InquiryFunctionMappingSrvResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryFunctionMappingSrvResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ESB_GYD_GYD_InquiryFunctionMappingSrvOutputCollection" type="{http://www.csot.tcl.com/ESB_GYD_GYD_InquiryFunctionMappingSrv/1.0}ESB_GYD_GYD_InquiryFunctionMappingSrvOutputCollection"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ESB_GYD_GYD_InquiryFunctionMappingSrvResponse", propOrder = {
    "serviceflag",
    "servicemessage",
    "instanceid",
    "totalrecord",
    ...
    "pagesize",
    "currentpage",
    "esbgydgydInquiryFunctionMappingSrvOutputCollection"
})
public class ESBGYDGYDInquiryFunctionMappingSrvResponse {
    ...
    @XmlElement(name = "ESB_GYD_GYD_InquiryFunctionMappingSrvOutputCollection", required = true)
    protected ESBGYDGYDInquiryFunctionMappingSrvOutputCollection esbgydgydInquiryFunctionMappingSrvOutputCollection;
    ...
    /**
     * ��ȡesbgydgydInquiryFunctionMappingSrvOutputCollection���Ե�ֵ��
     * 
     * @return
     *     possible object is
     *     {@link ESBGYDGYDInquiryFunctionMappingSrvOutputCollection }
     *     
     */
    public ESBGYDGYDInquiryFunctionMappingSrvOutputCollection getESBGYDGYDInquiryFunctionMappingSrvOutputCollection() {
        return esbgydgydInquiryFunctionMappingSrvOutputCollection;
    }

    /**
     * ����esbgydgydInquiryFunctionMappingSrvOutputCollection���Ե�ֵ��
     * 
     * @param value
     *     allowed object is
     *     {@link ESBGYDGYDInquiryFunctionMappingSrvOutputCollection }
     *     
     */
    public void setESBGYDGYDInquiryFunctionMappingSrvOutputCollection(ESBGYDGYDInquiryFunctionMappingSrvOutputCollection value) {
        this.esbgydgydInquiryFunctionMappingSrvOutputCollection = value;
    }
