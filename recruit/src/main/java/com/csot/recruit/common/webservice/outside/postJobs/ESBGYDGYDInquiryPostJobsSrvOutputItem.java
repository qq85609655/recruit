...
/**
 * <p>ESB_GYD_GYD_InquiryPostJobsSrvOutputItem complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="ESB_GYD_GYD_InquiryPostJobsSrvOutputItem">
 *   &lt;complexContent>
...
@XmlType(name = "ESB_GYD_GYD_InquiryPostJobsSrvOutputItem", propOrder = {
    "contenttype",
    "contentlength",
    "binarycontent",
    "asciicontent",
...
public class ESBGYDGYDInquiryPostJobsSrvOutputItem {
