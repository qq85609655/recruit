...
public class Addressbook implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTellphoneNo() == null ? other.getTellphoneNo() == null : this.getTellphoneNo().equals(other.getTellphoneNo()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTellphoneNo() == null) ? 0 : getTellphoneNo().hashCode());
